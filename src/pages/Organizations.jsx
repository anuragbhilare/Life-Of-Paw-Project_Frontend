                    ...
                    <form onSubmit={handleSubmitDossier} className="flex flex-col gap-4 font-sans text-left">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="w-full bg-stone-50 border border-[#D8D2C4]/70 hover:border-[#D4A017]/40 focus:border-[#D4A017] focus:ring-1 focus:ring-[#D4A017] rounded-xl py-2.5 px-3.5 text-xs focus:outline-none transition-all text-stone-855 font-medium"
                        />
                      </div>
