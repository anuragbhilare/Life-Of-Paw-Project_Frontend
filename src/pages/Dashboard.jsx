...
import { apiCall, apiClient, clearAuthCredentials, setAuthCredentials, API_BASE_URL, getImageUrl } from '../services/api';
              ...
              {activeTab === 'companion_inventory' && viewMode === 'sanctuary' && (() => {
                const adaptedAnimals = (managedAnimals || []).map(animal => {
                  ...
                  if (imagesList && imagesList.length > 0) {
                    ...
                    if (imgUrl) {
                      resolvedImage = getImageUrl(imgUrl);
                    }
                  }
